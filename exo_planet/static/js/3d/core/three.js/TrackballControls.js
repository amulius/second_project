...
//	this.domElement.addEventListener( 'contextmenu', function ( event ) { event.preventDefault(); }, false );
	this.domElement.on( 'contextmenu', function ( event ) { event.preventDefault(); }, false );

//	this.domElement.addEventListener( 'mousedown', mousedown, false );
//	this.domElement.on( 'mousedown', mousedown, false );
	this.domElement.on( 'mousedown', false, mousedown );

//	this.domElement.addEventListener( 'mousewheel', mousewheel, false );
//	this.domElement.on( 'mousewheel', mousewheel, false );
	this.domElement.on( 'mousewheel', false, mousewheel );
//	this.domElement.addEventListener( 'DOMMouseScroll', mousewheel, false ); // firefox
//	this.domElement.on( 'DOMMouseScroll', mousewheel, false ); // firefox
	this.domElement.on( 'DOMMouseScroll', false, mousewheel ); // firefox

//	this.domElement.addEventListener( 'touchstart', touchstart, false );
//	this.domElement.on( 'touchstart', touchstart, false );
	this.domElement.on( 'touchstart', false, touchstart );
//	this.domElement.addEventListener( 'touchend', touchend, false );
//	this.domElement.on( 'touchend', touchend, false );
	this.domElement.on( 'touchend', false, touchend );
//	this.domElement.addEventListener( 'touchmove', touchmove, false );
//	this.domElement.on( 'touchmove', touchmove, false );
	this.domElement.on( 'touchmove', false, touchmove );
